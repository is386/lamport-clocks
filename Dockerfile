...
ENV CLUSTER_SEEDS "[]"
ENV CLUSTER_IP ""
ENV CLUSTER_PORT "4056"


# 4056 is Akka.NET itself
# 9112 is Petabridge's Petabridge.Cmd (https://cmd.petabridge.com/articles/quickstart.html) which is
